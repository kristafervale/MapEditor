...
namespace BenTools.Mathematics
{
		...
		public class Vector : IEnumerable, IComparable
		{
			...
			: this(O.data)
				...
				{
						return new Vector3 ((float)data [0], 0, (float)data [1]);
				}
				...
				/// <summary>
				/// Added by Kris Vale 1/26/2014 to aide in clamping to a border
				/// </summary>
				/// <param name="min">Minimum.</param>
				/// <param name="max">Max.</param>
				public void Clamp (double min, double max)
				{
						this [0] = math_utilities.ClampAnything (this [0], min, max);
						this [1] = math_utilities.ClampAnything (this [1], min, max);
				}
